...
#
# Generated by export_simulation on Wed Jan 22 10:52:17 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './GTX_ROD_Link.sh' script.

./GTX_ROD_Link.sh -reset_run
...
./GTX_ROD_Link.sh -noclean_files

For more information on the script, please type './GTX_ROD_Link.sh -help'.
