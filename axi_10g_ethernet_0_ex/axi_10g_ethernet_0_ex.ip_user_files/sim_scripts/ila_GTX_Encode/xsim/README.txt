...
#
# Generated by export_simulation on Wed Jan 22 11:01:36 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './ila_GTX_Encode.sh' script.

./ila_GTX_Encode.sh -reset_run
...
./ila_GTX_Encode.sh -noclean_files

For more information on the script, please type './ila_GTX_Encode.sh -help'.
